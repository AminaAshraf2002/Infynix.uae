...
const CAMEL_OK = [
  ...
  'eCommerce', 'PowerPoint', 'OpenAI', 'ChatGPT', 'PageSpeed', 'BigQuery', 'QuickBooks', 'PayTabs',
  'HubSpot', 'ShipRocket', 'UI/UX', 'JavaScript SEO', 'GraphQL', 'GraphQL API', 'TikTok', 'YouTube Shorts', 'DoH', 'ADGM', 'KIZAD',
];
